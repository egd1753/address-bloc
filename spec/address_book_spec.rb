 ...
 RSpec.describe AddressBook do
   ...
   describe "attributes" do
     ...
     it "responds to entries from entries_2" do
       ...
       entry_one = book.entries[0]
       check_entry(entry_one, "Benny Liquid", "444-444-4444", "benny@email.com")
     end

     it "imports the 2nd entry from entries_2" do
       book.import_from_csv("entries_2.csv")
       entry_two = book.entries[1]
       check_entry(entry_two, "Buck Pucker", "333-333-3333", "buck@email.com")
     end

     it "imports the 3rd entry from entries_2" do
       book.import_from_csv("entries_2.csv")
       entry_three = book.entries[2]
       check_entry(entry_three, "Dicky Lipton", "555-555-5555", "Dicky@email.com")
     end
